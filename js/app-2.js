...
app.config([
    "$provide", "$routeProvider", "$httpProvider", function($provide, $routeProvider, $httpProvider) {
        ...
        $routeProvider.when("/home", {
            templateUrl: "Web_App/views/App/Home.html",
            controller: "homeCtrl"
        });
        $routeProvider.when("/register", {
            templateUrl: "Web_App/views/App/Register.html",
            controller: "registerCtrl"
        });
        $routeProvider.when("/signin/:message?", {
            templateUrl: "Web_App/views/App/SignIn.html",
            controller: "signInCtrl"
        });
        $routeProvider.when("/todomanager", {
            templateUrl: "Web_App/views/App/UsersManager.html",
            controller: "rimUsersCtrl"
        });
...
app.run([
    "$http", "$cookies", "$cookieStore", function($http, $cookies, $cookieStore) {
