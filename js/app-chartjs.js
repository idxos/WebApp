(function () {
  ...
  app.controller('DoughnutCtrl', ['$scope', '$timeout', function ($scope, $timeout) {
    $scope.labels = ['Checked-Out', 'Available', 'Processing'];
    $scope.data = [0, 0, 0];
  ...
  app.controller('DoughnutProcessesCtrl', ['$scope', '$timeout', function ($scope, $timeout) {
    $scope.labels = ['Reformating HD Disk Image', 'Installing Boos OS', 'Complete'];
    $scope.data = [0, 0, 0];
  ...
  app.controller('DoughnutLicensesCtrl', ['$scope', '$timeout', function ($scope, $timeout) {
    $scope.labels = ['All Licenses', 'Active Licenses', 'Available Licenses'];
    $scope.data = [0, 0, 0];

    $timeout(function () {
      $scope.data = [600, 300, 100];
    }, 500);
  }]);
